employee_data<-read.csv('employee_data.csv', header = TRUE , sep = "," , dec = ".")
...
#RMSE,Kok Ortalama Kare Hatasi, bir regresyon modelinin tahminlerinin gercek degerlerden ne kadar uzaklastigini olcen bir hata metrikidir.
#Dusukk olmasi beklenir
...
##MAE,Ortalama Mutlak Hata, regresyon analizinde kullanilan bir baska hata metrikidir. 
#RMSE gibi, modelin tahminlerinin gercek degerlerden ne kadar uzaklastigini olcer. 
#Ancak RMSE'den farkli olarak, hatalar??n mutlak degerlerinin ortalamasini alir.
...
#MAPE, ozellikle tahminlerin dogrulugunun yuzde olarak ifade edilmesi onemli oldugunda kullanilir.
...
#K-Fold Cross Validation, makine ogrenmesi modellerinin performansini degerlendirmek icin guclu ve yaygin olarak kullanilan bir tekniktir. 
#Modelin genelleme yetenenegini olcerek, daha guvenilir sonuclar elde edilmesini saglar.
library(caret)
